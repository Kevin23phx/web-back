...
__decorate([
    ...
    (0, class_validator_1.IsIn)(['plastic', 'organic', 'metal', 'glass', 'other']),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Central Park, Paris' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], CreateReportDto.prototype, "address", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'medium', enum: ['none', 'low', 'medium', 'high'] }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsIn)(['none', 'low', 'medium', 'high']),
    __metadata("design:type", String)
