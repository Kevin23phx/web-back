...
export declare class ReportsController {
    ...
    create(req: any, createReportDto: CreateReportDto, files: Express.Multer.File[]): Promise<import("./schemas/report.schema").ReportDocument>;
    ...
    like(id: string, req: any): Promise<import("./schemas/report.schema").ReportDocument | null>;
    incrementViews(id: string, req: any): Promise<import("./schemas/report.schema").ReportDocument | null>;
    remove(id: string): Promise<import("./schemas/report.schema").ReportDocument | null>;
}
